            ...
            <div className="w-full flex flex-col">
              ...
              <div className="w-full h-[150px] px-10 mt-5 ">
                <div className="w-full h-full flex flex-col border border-black px-5 py-3 gap-2">
                    ...
                    <p className="text-xl font-extrabold text-dash">Magna Carta for Disabled Persons, 1992, Republic Act No. 7277</p>
                    </Link>
              ...
              <div className="w-full h-[150px] px-10 mt-5 ">
                <div className="w-full h-full flex flex-col border border-black px-5 py-3 gap-2">
                    ...
                    <p className="text-xl font-extrabold text-dash"> Batas Pambansa Blg. 344</p>
                    </Link>
                    <p className="text-lg text-blue-600">
              ...
              <div className="w-full h-[150px] px-10 mt-5 ">
                <div className="w-full h-full flex flex-col border border-black px-5 py-3 gap-2">
                    ...
                    <p className="text-xl font-extrabold text-dash"> Republic Act No. 11228 </p>
                    </Link>
                    <p className="text-lg text-blue-600">
              ...
              <div className="w-full h-[150px] px-10 mt-5 mb-5 ">
                <div className="w-full h-full flex flex-col border border-black px-5 py-3 gap-2">
                    ...
                    <p className="text-xl font-extrabold text-dash"> Republic Act NO. 10754</p>
                    </Link>
                    <p className="text-lg text-blue-600">
